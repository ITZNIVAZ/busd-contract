...
contract BUSDImplementation {
    ...
    string public constant name = "CloudIn INR"; // solium-disable-line
    string public constant symbol = "CINR"; // solium-disable-line uppercase
    ...
    */
    ...
    function TokenDetails() public view returns (string memory, string memory, uint8, uint256) {
